...
(function ($) {
    ...
    $.fn.Page = function (options) {
        ...
        return this.each(function () {
            ...
            if (l > 1 && l < parseInt(n) + 1) {

                for (i = 2; i < parseInt(l) + 1; i++) {
            ...
            obj.on('click', '.next', function () {
                ...
                var path = "/owner/list/" + parseInt(pageshow + 1);
                ajaxCall(path);
            });
            ...
            obj.on('click', '.last', function () {
                ...
                if (l > n) {
                    fpageNext(n - 1);
                    path = "/owner/list/" + parseInt(n);
                } else {
                    fpageNext(l - 1);
                    path = "/owner/list/" + parseInt(l);
                }
                ajaxCall(path);
            });
            ...
            obj.on('click', 'li', function () {
                ...
                path = "/owner/list/" + parseInt(pageshow);
                ajaxCall(path);
            });
